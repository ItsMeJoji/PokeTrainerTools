      ...
      <div class="space-y-12">
        ...
        <section class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700">
          ...
          <p class="text-gray-600 dark:text-gray-400 leading-relaxed text-lg mb-6">
            A <span class="font-bold text-[#ef4444] dark:text-red-300">Ribbon Master</span> (RM) is a single Pokémon that has obtained <span class="italic">every single ribbon possible</span> for it to achieve from its game of origin all the way to the current generation.
          </p>
          <div class="grid md:grid-cols-2 gap-6">
            <div class="p-5 brand-panel-yellow">
              <h3 class="font-bold brand-text-yellow mb-2">The Golden Rule</h3>
              <p class="text-sm brand-text-yellow">A Pokémon only needs the ribbons available <span class="font-bold">starting from its origin game</span>. A Pikachu caught in Gen 6 doesn't need Gen 3 ribbons to be a RM!</p>
            </div>
            <div class="p-5 brand-panel-red">
              <h3 class="font-bold brand-text-red mb-2">The Community</h3>
              <p class="text-sm brand-text-red">Many trainers like to share progress and advice on the <span class="font-bold">r/pokemonribbons</span> subreddit.</p>
            </div>
          </div>
        </section>
        ...
        <section class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700">
          ...
          <div class="space-y-8">
            <div class="relative pl-8 border-l-2 brand-timeline">
              <div class="absolute -left-[9px] top-0 w-4 h-4 rounded-full brand-marker-yellow border-4 border-white dark:border-gray-800"></div>
        ...
        <section class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700">
          ...
          <div class="grid sm:grid-cols-2 gap-4">
            ...
            <div class="p-4 bg-gray-50 dark:bg-gray-900 rounded-xl">
              <span class="text-xs font-black text-[#ef4444] uppercase">Tip 03</span>
            ...
            <div class="p-4 bg-gray-50 dark:bg-gray-900 rounded-xl">
              <span class="text-xs font-black text-[#ef4444] uppercase">Tip 04</span>
        ...
        <section class="bg-white dark:bg-gray-800 p-10 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 text-center transform transition hover:scale-[1.01] flex flex-col items-center">
          ...
          <button id="guide-cta-btn" class="tool-cta border-none cursor-pointer text-white px-8 py-3 rounded-full font-bold shadow-md" style="background-color: #ef4444; align-self: center">
            Ribbon Tracker Tool
          </button>
        </section>
      </div>
